...
import (
	"github.com/NATCHAYATP/E-Commerce/pkg/ecommercelogger"
...
func (r *Response) Success(code int, data any) IResponse {
	r.StatusCode = code
	r.Data = data
	ecommercelogger.InitEcommerceLogger(r.Context, &r.Data).Print().Save()
	return r
}
...
func (r *Response) Error(code int, traceId, msg string) IResponse {
	...
	r.IsError = true
	ecommercelogger.InitEcommerceLogger(r.Context, r.ErrorRes).Print().Save()
	return r
}
